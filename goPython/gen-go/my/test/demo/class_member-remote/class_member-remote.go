...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "   List(i64 callTime)")
	fmt.Fprintln(os.Stderr, "  string Get(string name)")
	fmt.Fprintln(os.Stderr, "  void Set(HourseSell s)")
...
func main() {
	...
	client := demo.NewClassMemberClientFactory(trans, protocolFactory)
	...
	case "IsNameExist":
		...
		argvalue0 := flag.Arg(1)
		value0 := argvalue0
		fmt.Print(client.IsNameExist(value0))
		fmt.Print("\n")
		break
	case "":
		Usage()
